...
export const StaffPasskeyModal = ({ onSuccess }: StaffPasskeyModalProps) => {
  ...
  const validatePasskey = async () => {
    ...
    try {
      // Get the staff passkey from environment variable
      const staffPasskey = process.env.NEXT_PUBLIC_STAFF_PASSKEY;
      
      if (passkey === staffPasskey) {
            ...
            <div className="flex justify-center">
              ...
              >
                <InputOTPGroup className="shad-otp">
                  <InputOTPSlot className="responsiveOtpSlot size-10 sm:size-12 md:size-16 text-xl sm:text-2xl md:text-3xl" index={0} />
                  <InputOTPSlot className="responsiveOtpSlot size-10 sm:size-12 md:size-16 text-xl sm:text-2xl md:text-3xl" index={1} />
                  <InputOTPSlot className="responsiveOtpSlot size-10 sm:size-12 md:size-16 text-xl sm:text-2xl md:text-3xl" index={2} />
                  <InputOTPSlot className="responsiveOtpSlot size-10 sm:size-12 md:size-16 text-xl sm:text-2xl md:text-3xl" index={3} />
                  <InputOTPSlot className="responsiveOtpSlot size-10 sm:size-12 md:size-16 text-xl sm:text-2xl md:text-3xl" index={4} />
                  <InputOTPSlot className="responsiveOtpSlot size-10 sm:size-12 md:size-16 text-xl sm:text-2xl md:text-3xl" index={5} />
                </InputOTPGroup>
              </InputOTP>
            </div>
