...
import { CalendarDays, Calendar, Filter, Search, X, CalendarClock } from "lucide-react";
...
const AppointmentsPage = ({ searchParams }: AppointmentsPageProps) => {
  ...
  const [doctorFilter, setDoctorFilter] = useState(searchParams.doctor || "all");
  ...
  useEffect(() => {
    async function fetchAppointments() {
      ...
      const data = await getAllAppointments({
        ...
        doctor: searchParams.doctor && searchParams.doctor !== "all" ? searchParams.doctor : "",
  ...
  return (
    <main className="transition-all duration-300 py-6 w-full px-4 lg:px-3 xl:px-4 max-w-full">
      <section className="w-full mb-8">
        <h1 className="text-32-bold text-white">Appointments</h1>
      </section>
        ...
        <div className="flex flex-col space-y-4">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            ...
            <div className="flex flex-wrap items-center gap-3 w-full sm:w-auto">
              ...
              {(searchValue || statusFilter !== "all" || doctorFilter !== "all" || startDate || endDate) && (
                <Button
                  variant="ghost"
                  size="sm"
          ...
          <div className="flex flex-wrap gap-3">
            ...
            <div className="flex-1 min-w-[120px]">
              ...
              >
                <SelectTrigger className="h-9 bg-dark-300 border-dark-500">
              ...
              <Popover>
                <PopoverTrigger asChild>
                  <Button
                    variant="outline"
                    size="sm"
                    className={`justify-start text-left font-normal h-9 bg-dark-300 border-dark-500 ${
      ...
      <div className="bg-dark-300 p-4 sm:p-6 rounded-lg border border-dark-400 shadow-md">
        <div className="flex justify-between items-center mb-4">
          <div className="flex items-center gap-2 text-gray-400">
            ...
            <p className="text-sm">Total: {totalAppointments} appointment{totalAppointments !== 1 ? 's' : ''}</p>
          </div>
          ...
          {(searchValue || statusFilter !== "all" || doctorFilter !== "all" || startDate || endDate) && (
            <div className="flex items-center gap-2">
              <div className="text-sm text-gray-400 hidden sm:flex items-center">
                ...
                {doctorFilter !== "all" && (
                  <span className="ml-2 px-2 py-1 bg-dark-400 rounded-md text-xs truncate max-w-[100px]">
        ...
        {loading ? (
          ...
          <div className="flex flex-col justify-center items-center h-48 text-center">
            <CalendarClock className="h-12 w-12 text-gray-600 mb-3" />
