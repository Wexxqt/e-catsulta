          ...
          <div className="flex justify-between items-start">
            <div>
              ...
              <h3 className="text-2xl sm:text-3xl font-bold mt-2 text-white">
                {(appointments?.studentCount || 0) + (appointments?.employeeCount || 0)}
              </h3>
              <div className="flex flex-col sm:flex-row sm:gap-2 mt-1">
                <span className="text-blue-400 text-xs font-medium">Students: {appointments?.studentCount || 0}</span>
                <span className="text-purple-400 text-xs font-medium">Employees: {appointments?.employeeCount || 0}</span>
              </div>
            </div>
        ...
        <div className="bg-dark-300 rounded-lg p-5 shadow hover:shadow-md transition-shadow border border-dark-400 w-full h-full flex-1">
          <div className="flex justify-between items-start">
            <div>
              ...
              <h3 className="text-2xl sm:text-3xl font-bold mt-2 text-white">{appointments?.todayCount || 0}</h3>
              {appointments?.pendingCount ? (
                <p className="text-yellow-400 text-xs font-medium mt-1">{appointments.pendingCount} pending confirmation</p>
              ) : (
                <p className="text-gray-400 text-xs font-medium mt-1">No pending appointments</p>
              )}
            </div>
        ...
        <div className="bg-dark-300 rounded-lg p-5 shadow hover:shadow-md transition-shadow border border-dark-400 w-full h-full flex-1">
          <div className="flex justify-between items-start">
            <div>
              ...
              <h3 className="text-2xl sm:text-3xl font-bold mt-2 text-white">{appointments?.scheduledCount || 0}</h3>
              <p className="text-green-400 text-xs font-medium mt-1">Confirmed appointments</p>
            </div>
        ...
        <div className="bg-dark-300 rounded-lg p-5 shadow hover:shadow-md transition-shadow border border-dark-400 w-full h-full flex-1">
          <div className="flex justify-between items-start">
            <div>
              ...
              <h3 className="text-2xl sm:text-3xl font-bold mt-2 text-white">{appointments?.cancelledCount || 0}</h3>
              <p className="text-red-400 text-xs font-medium mt-1">Total cancelled</p>
            </div>
